...
/* Dalam contoh ini, kita memiliki kelas `Mahasiswa` dengan dua variabel instance private
(`nama` dan `umur`). Kita menggunakan metode getter dan setter untuk mengakses dan mengubah 
nilai-nilai ini, sehingga menerapkan enkapsulasi. */